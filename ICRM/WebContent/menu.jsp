									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer_add"  target=main>－ 新增客户</A>
													</TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkMan_add" target=main>－ 新增联系人</A>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/saleVisit_add" target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
