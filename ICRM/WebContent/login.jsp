							        	...
							        	<TR>
							          		...
							          		<TD>
									            <TABLE cellSpacing=0 cellPadding=2 border=0>
		              								<TBODY>
										              	<TR>
										                	<TD colspan="3" style="HEIGHT: 28px" width=80><font color="red"><s:property value="#msg"/></font></TD>
										              	...
										              	<TR>
										                	...
										                	<TD style="HEIGHT: 28px"><img  height="90%" width="35%" src="${pageContext.request.contextPath }/code" onclick="changeImg(this)"></TD>
										                </TR>
										              	<TR>
										              	...
										              	<TR>
                											<TD></TD>
                											<TD>
                												<INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px " onclick='javascript:submit("$("#form1")")'  type=image src="${pageContext.request.contextPath}/images/login_button.gif" name=btn> 
              												</TD>
              											</TR>
              										</TBODY>
              									</TABLE>
