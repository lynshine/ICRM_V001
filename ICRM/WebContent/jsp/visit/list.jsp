...
<script type="text/javascript">
	...
	$(function(){
		...
		$.get(url  , 
				function(result){
			var oldId = "${visit_cust_id.cust_id}";
										...
										<table cellspacing="0" cellpadding="2" border="0">
											<tbody>
												<tr>
													<td>客户名称：</td>
													<td>
														<select id="customer" name="visit_cust_id.cust_id" class="textbox" style="width: 140px; height: 21px;">
									...
									<td>
										<table id="grid"
											...
											<tbody>
												...
												<s:iterator var="visit" value="#pageBean.list">
													<tr style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													
														<!-- 如果取得值位于context区域，那么要记得加上 # -->
													
														<td>${visit.visit_cust_id.cust_name }</td>
														<td><s:property value="#visit.visit_time" /></td>
														<%-- <td><fmt:formatDate value="${visit.visit_time }" pattern="yyyy年MM月dd日"/></td> --%>
														<td><s:property value="#visit.visit_lkm_id.lkm_name" /></td>
														...
														<%-- <td><fmt:formatDate value="${visit.visit_nexttime }" pattern="yyyy年MM月dd日"/></td> --%>
													</tr>
												</s:iterator>
